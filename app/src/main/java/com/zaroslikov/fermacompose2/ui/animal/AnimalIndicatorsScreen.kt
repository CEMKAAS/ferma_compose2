...
object AnimalIndicatorsDestination : NavigationDestination {
    ...
    val routeWithArgs =
        "${AnimalIndicatorsDestination.route}/{$itemIdArg}/{$itemIdArgTwo}/{$itemIdArgThree}"
}
...
@Composable
private fun AnimalIndicatorsList(
    itemList: List<FinTit>,
