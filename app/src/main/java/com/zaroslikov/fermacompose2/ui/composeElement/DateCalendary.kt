    ...
    DatePickerDialog(
        ...
        confirmButton = {
            TextButton(
                ...
                Text(text = stringResource(R.string.data_picker_ok))
            }
        },
        dismissButton = {
            TextButton(onClick = onDismiss) {
                Text(text = stringResource(R.string.data_picker_back))
            }
        }
    ) {
        DateRangePicker(
            ...
            title = {
                Text(
                    text = stringResource(R.string.data_picker_choice_period)
                )
            },
