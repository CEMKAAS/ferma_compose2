...
fun BottomSheetExpensesAnimal(
    ...
    EntryIndicationBottomSheet(
        ...
        onInsertClick = { onIntent(AnimalCountIntent.InsertExpensesPressed) },
        onUpdateClick = { onIntent(AnimalCountIntent.UpdateExpensesPressed) }
    ) {
