...
data class BackupData(
    ...
    val timeNotificationProjectTable: List<DomainTimeNotificationProject> = emptyList(),
    ...
    val timeNotificationIncubatorTable: List<DomainTimeNotificationIncubator> = emptyList(),
